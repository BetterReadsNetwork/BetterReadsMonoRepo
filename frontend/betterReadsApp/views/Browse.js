...
export default class Browse extends React.Component {
  ...
  addToLibrary =(book)=>{
    return fetch(this.state.base+'/createBook?title='+book, {
      method: 'GET'
  ...
  startDiscussion(book){
   return fetch(this.state.base+'/createThread?title='+book, {
      method: 'GET'
  ...
  componentDidMount(){
   var url = this.state.base+'/api/browse/'+this.props.navigation.getParam('query','NO-ID')
    return fetch(url, {
      method: 'GET'
