...
*//*
    ...
    render() {
        if (this.state.edit) {
            ...
            return ( 
              <View style={{alignItems: 'center', flex: 1, flexDirection: 'column'}}>
			    	  <Image style={{height: 50, width: 50}} source="https://raw.githubusercontent.com/BetterReadsNetwork/BetterReadsMonoRepo/master/frontend/first-navigation%202/dummyImg.png" />
